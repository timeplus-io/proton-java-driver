package com.timeplus.proton.client.grpc.config;
 ...
 * gRPC client options.
 */
public enum ProtonGrpcOption implements ProtonOption {
    /**
     * Flow control window.
     */
    ...
    <T extends Serializable> ProtonGrpcOption(String key, T defaultValue, String description) {
