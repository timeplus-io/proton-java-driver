...
public class ProtonGeoPointValueTest {
    @Test(groups = { "unit" })
    public void testUpdate() {
        ProtonGeoPointValue v = ProtonGeoPointValue.of(new double[] { 1D, 2D });
        ...
        Assert.assertThrows(UnsupportedOperationException.class, () -> v.update(ProtonDataType.array));
    }
}
