...
public class ProtonLZ4OutputStreamTest {
    private byte[] genCompressedByts(int b, int length, int blockSize) throws IOException {
        ...
        try (ProtonLZ4OutputStream out = new ProtonLZ4OutputStream(bas, blockSize)) {
    ...
    public void testCompressAndDecompressQuery() throws IOException {
        ...
        try (ProtonLZ4OutputStream out = new ProtonLZ4OutputStream(bas,
                (int) ProtonClientOption.MAX_COMPRESS_BLOCK_SIZE.getDefaultValue())) {
        ...
        try (ProtonLZ4InputStream in = new ProtonLZ4InputStream(new ByteArrayInputStream(bas.toByteArray()))) {
    ...
    public void testWrite() throws IOException {
        ...
        try (ProtonLZ4OutputStream out = new ProtonLZ4OutputStream(bas, 2)) {
    ...
    public void testWriteBytes() throws IOException {
        Assert.assertThrows(NullPointerException.class, new Assert.ThrowingRunnable() {
            ...
            public void run() throws Throwable {
                try (ProtonLZ4OutputStream out = new ProtonLZ4OutputStream(new ByteArrayOutputStream(), 3)) {
                    out.write(null);
                }
            }
        });
        ...
        ByteArrayOutputStream bas = new ByteArrayOutputStream(64);
        try (ProtonLZ4OutputStream out = new ProtonLZ4OutputStream(bas, 3)) {
