...
public class ProtonIntegerValueTest extends BaseProtonValueTest {
    @Test(groups = { "unit" })
    public void testValue() throws Exception {
        // null value
        checkNull(ProtonIntegerValue.ofNull());
        checkNull(ProtonIntegerValue.of(Integer.MAX_VALUE).resetToNullOrEmpty());

        // non-null
        checkValue(ProtonIntegerValue.of(0), false, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonIntegerValue.of(1), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
        ...
        checkValue(ProtonIntegerValue.of(2), false, // isInfinity
                false, // isNan
                false, // isNull
