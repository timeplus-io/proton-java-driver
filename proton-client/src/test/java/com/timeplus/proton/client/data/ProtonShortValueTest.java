...
public class ProtonShortValueTest extends BaseProtonValueTest {
    @Test(groups = { "unit" })
    public void testValue() throws Exception {
        // null value
        checkNull(ProtonShortValue.ofNull());
        checkNull(ProtonShortValue.of(Short.MAX_VALUE).resetToNullOrEmpty());

        // non-null
        checkValue(ProtonShortValue.of(0), false, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonShortValue.of(1), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
        ...
        checkValue(ProtonShortValue.of(2), false, // isInfinity
                false, // isNan
                false, // isNull
