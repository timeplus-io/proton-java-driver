...
public class ProtonByteValueTest extends BaseProtonValueTest {
    @Test(groups = { "unit" })
    public void testUpdate() throws Exception {
        ProtonByteValue v = ProtonByteValue.of(-1);
    ...
    public void testValue() throws Exception {
        // null value
        checkNull(ProtonByteValue.ofNull());
        checkNull(ProtonByteValue.of(Byte.MIN_VALUE).resetToNullOrEmpty());
        checkNull(ProtonByteValue.of(Byte.MAX_VALUE).resetToNullOrEmpty());

        // non-null
        checkValue(ProtonByteValue.of(0), false, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonByteValue.of(1), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
        ...
        checkValue(ProtonByteValue.of(2), false, // isInfinity
                false, // isNan
                false, // isNull
