...
public class ProtonBoolValueTest extends BaseProtonValueTest {
    @Test(groups = { "unit" })
    public void testUpdate() throws Exception {
        ProtonBoolValue v = ProtonBoolValue.of(0);
    ...
    public void testValue() throws Exception {
        // null value
        checkNull(ProtonBoolValue.ofNull());
        checkNull(ProtonBoolValue.of(1).resetToNullOrEmpty());
        checkNull(ProtonBoolValue.of(0).resetToNullOrEmpty());
        checkNull(ProtonBoolValue.of(true).resetToNullOrEmpty());
        checkNull(ProtonBoolValue.of(false).resetToNullOrEmpty());

        // invalid values
        Assert.assertThrows(IllegalArgumentException.class, () -> ProtonBoolValue.of(2));
        Assert.assertThrows(IllegalArgumentException.class, () -> ProtonBoolValue.of(-1));

        // non-null
        checkValue(ProtonBoolValue.of(0), false, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonBoolValue.of(1), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
        ...
        checkValue(ProtonBoolValue.of(false), false, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonBoolValue.of(true), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
