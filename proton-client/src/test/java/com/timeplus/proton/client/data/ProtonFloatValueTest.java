...
public class ProtonFloatValueTest extends BaseProtonValueTest {
    @Test(groups = { "unit" })
    public void testValue() throws Exception {
        // null value
        checkNull(ProtonFloatValue.ofNull());
        checkNull(ProtonFloatValue.of(Float.MAX_VALUE).resetToNullOrEmpty());

        // NaN and Infinity
        checkValue(ProtonFloatValue.of(Float.NaN), false, // isInfinity
                true, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonFloatValue.of(Float.POSITIVE_INFINITY), true, // isInfinity
                false, // isNan
                false, // isNull
        ...
        checkValue(ProtonFloatValue.of(Float.NEGATIVE_INFINITY), true, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        // non-null
        checkValue(ProtonFloatValue.of(0F), false, // isInfinity
                false, // isNan
                false, // isNull
                false, // boolean
                (byte) 0, // byte
        ...
        checkValue(ProtonFloatValue.of(1F), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
        ...
        checkValue(ProtonFloatValue.of(2F), false, // isInfinity
                false, // isNan
                false, // isNull
                IllegalArgumentException.class, // boolean
                (byte) 2, // byte
        ...
        checkValue(ProtonFloatValue.of(4F / 3), false, // isInfinity
                false, // isNan
                false, // isNull
                true, // boolean
                (byte) 1, // byte
