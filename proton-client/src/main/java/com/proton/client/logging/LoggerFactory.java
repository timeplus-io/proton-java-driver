package com.proton.client.logging;
...
public abstract class LoggerFactory {
    ...
    static {
        instance = ProtonUtils.getService(LoggerFactory.class, () -> {
            ...
            return ProtonChecker.nonNull(factory, "factory");
        });
    }
    ...
    public Logger get(Class<?> clazz) {
        return get(ProtonChecker.nonNull(clazz, "Class").getName());
    }
