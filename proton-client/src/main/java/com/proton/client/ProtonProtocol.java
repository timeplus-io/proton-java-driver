...
/**
 * This defines protocols can be used to connect to Proton.
 */
public enum ProtonProtocol {
    /**
     ...
     */
    public static ProtonProtocol fromUriScheme(String scheme) {
        ProtonProtocol protocol = ANY;

        for (ProtonProtocol p : values()) {
    ...
    ProtonProtocol(int defaultPort, String... schemes) {
