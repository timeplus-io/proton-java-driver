...
/**
 * Summary of Proton response.
 */
public class ProtonResponseSummary implements Serializable {
    private static final long serialVersionUID = 6241261266635143197L;

    public static final ProtonResponseSummary EMPTY = new ProtonResponseSummary(null, null, true);
    ...
    public ProtonResponseSummary(Progress progress, Statistics stats) {
     ...
     */
    protected ProtonResponseSummary(Progress progress, Statistics stats, boolean sealed) {
