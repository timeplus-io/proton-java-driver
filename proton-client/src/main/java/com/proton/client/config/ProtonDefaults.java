 ...
 */
public enum ProtonDefaults implements ProtonOption {
    /**
     ...
     * Default protocol.
     */
    PROTOCOL("protocol", ProtonProtocol.ANY, "Protocol to use."),
    /**
     * Default server port.
     */
     ...
     * Default format.
     */
    FORMAT("format", ProtonFormat.TabSeparated, "Preferred data format for serialization and deserialization."),
    /**
     * Max threads.
     */
     ...
     * {@link com.proton.client.naming.SrvResolver}(e.g. resolve SRV record to
    ...
    <T extends Serializable> ProtonDefaults(String key, T defaultValue, String description) {
