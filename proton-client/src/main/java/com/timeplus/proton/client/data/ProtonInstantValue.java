 ...
 */
public class ProtonInstantValue extends ProtonObjectValue<Instant> {
    /**
     ...
     */
    public static ProtonInstantValue ofNull(int scale, TimeZone tz) {
     ...
     */
    public static ProtonInstantValue ofNull(ProtonValue ref, int scale, TimeZone tz) {
        return ref instanceof ProtonInstantValue
                ? (ProtonInstantValue) ((ProtonInstantValue) ref).set(null)
                : new ProtonInstantValue(null, scale, tz);
    }
     ...
     */
    public static ProtonInstantValue of(Instant value, int scale, TimeZone tz) {
     ...
     * @return object representing the value
     */
    public static ProtonInstantValue of(String value, int scale, TimeZone tz) {
        return of(null, value, scale, tz);
    }
     ...
     * @return same object as {@code ref} or a new instance if it's null
     */
    public static ProtonInstantValue of(ProtonValue ref, Instant value, int scale, TimeZone tz) {
        return ref instanceof ProtonInstantValue
                ? (ProtonInstantValue) ((ProtonInstantValue) ref).set(value)
                : new ProtonInstantValue(value, scale, tz);
    }
     ...
     * @return same object as {@code ref} or a new instance if it's null
     */
    public static ProtonInstantValue of(ProtonValue ref, String value, int scale, TimeZone tz) {
        Instant dateTime = value == null || value.isEmpty() ? null
                : LocalDateTime.parse(value, ProtonValues.DATETIME_FORMATTER).atZone(tz.toZoneId()).toInstant();
    ...
    protected ProtonInstantValue(Instant value, int scale, TimeZone tz) {
        super(value);
    ...
    @Override
    public ProtonInstantValue copy(boolean deep) {
        return new ProtonInstantValue(getValue(), scale, tz);
    }
    ...
    public float asFloat() {
        return isNullOrEmpty() ? 0F
                : getValue().getEpochSecond() + getValue().getNano() / ProtonValues.NANOS.floatValue();
    }
    ...
    @Override
    public ProtonInstantValue update(byte value) {
        return update(BigInteger.valueOf(value));
    }

    @Override
    public ProtonInstantValue update(short value) {
        return update(BigInteger.valueOf(value));
    }

    @Override
    public ProtonInstantValue update(int value) {
        return update(BigInteger.valueOf(value));
    }

    @Override
    public ProtonInstantValue update(long value) {
        return update(BigInteger.valueOf(value));
    }

    @Override
    public ProtonInstantValue update(float value) {
        return update(BigDecimal.valueOf(value));
    }

    @Override
    public ProtonInstantValue update(double value) {
        return update(BigDecimal.valueOf(value));
    }

    @Override
    public ProtonInstantValue update(BigInteger value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else if (scale == 0) {
            set(ProtonValues.convertToInstant(new BigDecimal(value, 0)));
        } else {
            set(ProtonValues.convertToInstant(new BigDecimal(value, scale)));
        }
        return this;
    }

    @Override
    public ProtonInstantValue update(BigDecimal value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
            ...
            set(ProtonValues.convertToInstant(value));
        }
        return this;
    }

    @Override
    public ProtonInstantValue update(Enum<?> value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
    ...
    @Override
    public ProtonInstantValue update(LocalDate value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
    ...
    @Override
    public ProtonInstantValue update(LocalTime value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
    ...
    @Override
    public ProtonInstantValue update(LocalDateTime value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
    ...
    @Override
    public ProtonInstantValue update(Instant value) {
        set(value);
        return this;
    }

    @Override
    public ProtonInstantValue update(OffsetDateTime value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
            set(value.toInstant());
    ...
    @Override
    public ProtonInstantValue update(ZonedDateTime value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
            set(value.toInstant());
    ...
    @Override
    public ProtonInstantValue update(String value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
            set(LocalDateTime.parse(value, ProtonValues.DATETIME_FORMATTER).atZone(tz.toZoneId()).toInstant());
        }
        return this;
    }

    @Override
    public ProtonInstantValue update(ProtonValue value) {
        if (value == null) {
            resetToNullOrEmpty();
        } else {
    ...
    @Override
    public ProtonInstantValue update(Object value) {
