package com.timeplus.proton.client.cache;

import java.util.Objects;
import java.util.concurrent.TimeUnit;
import java.util.function.Function;

import com.timeplus.proton.client.ProtonCache;
 ...
 * a LRU cache.
 */
public class CaffeineCache<K, V> implements ProtonCache<K, V> {
     ...
     * @return cache
     */
    public static <K, V> ProtonCache<K, V> create(int capacity, long expireSeconds, Function<K, V> loadFunc) {
