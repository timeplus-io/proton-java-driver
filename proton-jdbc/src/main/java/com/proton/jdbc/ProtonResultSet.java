...
public class ProtonResultSet extends AbstractResultSet {
    private ProtonRecord currentRow;
    private Iterator<ProtonRecord> rowCursor;
    ...
    protected final ProtonStatement statement;
    protected final ProtonResponse response;
    ...
    protected final ProtonResultSetMetaData metaData;

    protected final Map<String, Class<?>> defaultTypeMap;

    // only for testing purpose
    ProtonResultSet(String database, String table, ProtonResponse response) {
        ...
        try {
            ...
            this.metaData = new ProtonResultSetMetaData(database, table, columns, defaultTypeMap);
    ...
    public ProtonResultSet(String database, String table, ProtonStatement statement,
            ProtonResponse response) throws SQLException {
        ...
        ProtonConnection conn = statement.getConnection();
    ...
    protected ProtonValue getValue(int columnIndex) throws SQLException {
        ensureRead(columnIndex);

        ProtonValue v = currentRow.getValue(columnIndex - 1);
    ...
    public int findColumn(String columnLabel) throws SQLException {
        ...
        throw SqlExceptionUtils.clientError(
                ProtonUtils.format("Column [%s] does not exist in %d columns", columnLabel, columns.size()));
    }

    @Override
    public Array getArray(int columnIndex) throws SQLException {
        return new ProtonArray(this, columnIndex);
    }

    @Override
    public Array getArray(String columnLabel) throws SQLException {
        return new ProtonArray(this, findColumn(columnLabel));
    }

    @Override
    public InputStream getAsciiStream(int columnIndex) throws SQLException {
        ProtonValue v = getValue(columnIndex);
    ...
    public Date getDate(int columnIndex, Calendar cal) throws SQLException {
        ProtonValue value = getValue(columnIndex);
    ...
    public Object getObject(int columnIndex, Map<String, Class<?>> map) throws SQLException {
        ...
        ProtonValue v = getValue(columnIndex);
        ProtonColumn c = columns.get(columnIndex - 1);
        ...
        if (!wrapObject) {
            ...
            value = new ProtonArray(this, columnIndex);
        } else if (c.isTuple() || c.isNested()) {
            value = new ProtonStruct(c.getDataType().name(), v.asArray());
        } else {
            value = javaType != null ? v.asObject(javaType) : v.asObject();
        }
    ...
    public Timestamp getTimestamp(int columnIndex, Calendar cal) throws SQLException {
        ...
        ProtonColumn column = columns.get(columnIndex - 1);
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        return iface == ProtonResponse.class || iface == ProtonRecord.class || super.isWrapperFor(iface);
    }

    @Override
    public <T> T unwrap(Class<T> iface) throws SQLException {
        if (iface == ProtonResponse.class) {
            return iface.cast(response);
        } else if (iface == ProtonRecord.class) {
