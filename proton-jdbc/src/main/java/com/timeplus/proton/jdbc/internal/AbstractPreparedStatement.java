...
public abstract class AbstractPreparedStatement extends ProtonStatementImpl implements PreparedStatement {
    protected AbstractPreparedStatement(ProtonConnectionImpl connection, ProtonRequest<?> request,
