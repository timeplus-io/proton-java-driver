...
public class JdbcConfig {
    ...
    static Map<String, Class<?>> extractTypeMapValue(Properties props, String key, String defaultValue) {
        ...
        for (Entry<String, String> e : ProtonUtils.getKeyValuePairs(value).entrySet()) {
            Class<?> clazz = null;
            try {
    ...
    public static List<DriverPropertyInfo> getDriverProperties() {
        ...
        info.description = "Default type mappings between Proton data type and Java class. You can define multiple mappings using comma as separator.";
        list.add(info);
