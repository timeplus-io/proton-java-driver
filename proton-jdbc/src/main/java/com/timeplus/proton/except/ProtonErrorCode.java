...
public enum ProtonErrorCode {
    ...
    private static final Map<Integer, ProtonErrorCode> byCodes;
    static {
        Map<Integer, ProtonErrorCode> map = new HashMap<Integer, ProtonErrorCode>();
        for (ProtonErrorCode errorCode : values())
            map.put(errorCode.code, errorCode);
        byCodes = Collections.unmodifiableMap(map);
    }

    ProtonErrorCode(Integer code) {
        this.code = code;
    }


    public static ProtonErrorCode fromCode(Integer code) {
