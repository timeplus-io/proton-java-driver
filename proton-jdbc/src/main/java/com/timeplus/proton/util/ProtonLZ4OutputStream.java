...
public class ProtonLZ4OutputStream extends OutputStream {
    ...
    public ProtonLZ4OutputStream(OutputStream stream, int maxCompressBlockSize) {
    ...
    private void writeBlock() throws IOException {
        ...
        ProtonBlockChecksum checksum = ProtonBlockChecksum.calculateForBlock((byte) ProtonLZ4Stream.MAGIC,
                compressed + 9, pointer, compressedBlock, compressed);
        dataWrapper.write(checksum.asBytes());
        dataWrapper.writeByte(ProtonLZ4Stream.MAGIC);
