...
public final class ProtonValueFormatter {
    ...
    public static String formatString(String myString) {
        return ProtonUtil.escape(myString);
    }
     ...
     * dedicated Proton data type for times, so this is the most
     * straightforward thing to do. It would be wrong for the JDBC driver to
     * construct an artificial {@link ProtonDataType#DateTime DateTime}
    ...
    public static String formatBitmap(ProtonBitmap bitmap) {
        ...
        TimeZone dateTimeTimeZone)
    {
        ...
        if (x instanceof Byte) {
            ...
            return ProtonArrayUtil.toString((Collection<?>) x, dateTimeZone, dateTimeTimeZone);
        } else if (x instanceof ProtonBitmap) {
            return formatBitmap((ProtonBitmap) x);
        } else if (x instanceof Map) {
            return formatMap((Map<?, ?>) x, dateTimeZone, dateTimeTimeZone);
        } else if (x.getClass().isArray()) {
            return ProtonArrayUtil.arrayToString(x, dateTimeZone, dateTimeTimeZone);
        } else {
    ...
    private ProtonValueFormatter() { /* NOP */ }
}
