 ...
 */
public class ProtonRowBinaryStream {
    ...
    public ProtonRowBinaryStream(OutputStream outputStream, TimeZone timeZone, ProtonProperties properties) {
    ...
    public void writeBitmap(ProtonBitmap rb) throws IOException {
