...
import com.timeplus.proton.ProtonStatement;
...
public class ProtonScrollableResultSet extends ProtonResultSet {
    
    private List<ByteFragment[]> lines;

    public ProtonScrollableResultSet(InputStream is, int bufferSize, String db, String table, boolean usesWithTotals, ProtonStatement statement, TimeZone timezone, ProtonProperties properties) throws IOException {
