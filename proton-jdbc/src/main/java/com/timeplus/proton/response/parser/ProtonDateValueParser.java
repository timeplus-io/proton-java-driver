...
abstract class ProtonDateValueParser<T> extends ProtonValueParser<T> {
    ...
    protected ProtonDateValueParser(Class<T> clazz) {
        this.clazz = Objects.requireNonNull(clazz);
    }

    protected LocalDateTime dateToLocalDate(String value, ProtonColumnInfo columnInfo, TimeZone timeZone) {
        return parseAsLocalDate(value).atStartOfDay();
    }

    protected LocalDateTime dateTimeToLocalDateTime(String value, ProtonColumnInfo columnInfo, TimeZone timeZone) {
    ...
    protected ZonedDateTime dateToZonedDateTime(String value, ProtonColumnInfo columnInfo, TimeZone timeZone) {
    ...
    protected ZonedDateTime dateTimeToZonedDateTime(String value, ProtonColumnInfo columnInfo, TimeZone timeZone) {
        LocalDateTime localDateTime = parseAsLocalDateTime(value);
    ...
    @Override
    public T parse(ByteFragment value, ProtonColumnInfo columnInfo, TimeZone timeZone) throws ProtonException {
        ...
        switch (columnInfo.getEffectiveProtonDataType()) {
        case Date:
            try {
    ...
    abstract T parseDate(String value, ProtonColumnInfo columnInfo,
        TimeZone timeZone);

    abstract T parseDateTime(String value, ProtonColumnInfo columnInfo,
        TimeZone timeZone);

    abstract T parseNumber(long value, ProtonColumnInfo columnInfo,
        TimeZone timeZone);

    abstract T parseOther(String value, ProtonColumnInfo columnInfo,
        TimeZone timeZone);

    protected final ZoneId effectiveTimeZone(ProtonColumnInfo columnInfo,
        TimeZone timeZone) {
