...
import com.timeplus.proton.util.ProtonBlockChecksum;
...
public class ProtonLZ4Stream extends InputStream {
    ...
    public ProtonLZ4Stream(InputStream stream) {
        this.stream = stream;
    ...
    private byte[] readNextBlock() throws IOException {
        ...
        ProtonBlockChecksum expected = ProtonBlockChecksum.fromBytes(checksum);
        // header:
        ...
        ProtonBlockChecksum real = ProtonBlockChecksum.calculateForBlock((byte)magic, compressedSizeWithHeader, uncompressedSize, block, compressedSize);
