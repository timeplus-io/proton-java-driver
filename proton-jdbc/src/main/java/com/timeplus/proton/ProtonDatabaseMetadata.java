...
import com.timeplus.proton.response.ProtonResultBuilder;


public class ProtonDatabaseMetadata implements DatabaseMetaData {
    ...
    public ProtonDatabaseMetadata(String url, ProtonConnection connection) {
        this.url = url;
    ...
    public String getDriverName() throws SQLException {
        return "com.timeplus.proton-jdbc";
    }
    ...
    public int getDriverMajorVersion() {
        ...
        return ProtonVersion.of(v).getMajorVersion();
    }
    ...
    public int getDriverMinorVersion() {
        ...
        return ProtonVersion.of(v).getMinorVersion();
    }
    ...
    public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern) throws SQLException {
        ProtonResultBuilder builder = ProtonResultBuilder.builder(9);
        builder.names(
                "PROCEDURE_CAT",
                "PROCEDURE_SCHEM",
                "PROCEDURE_NAME",
    ...
    public ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedureNamePattern, String columnNamePattern) throws SQLException {
        ProtonResultBuilder builder = ProtonResultBuilder.builder(20);
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
        ...
        ProtonResultBuilder builder = ProtonResultBuilder.builder(10);
    ...
    public ResultSet getCatalogs() throws SQLException {
        ProtonResultBuilder builder = ProtonResultBuilder.builder(1);
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException {
        StringBuilder query;
        if (ProtonVersion.check(connection.getServerVersion(), "[18.16,)")) {
        ...
        ProtonResultBuilder builder = getProtonResultBuilderForGetColumns();
        ...
        while (descTable.next()) {
            ...
            //column name
            ProtonColumnInfo columnInfo = ProtonColumnInfo.parse(
                descTable.getString("type"),
                descTable.getString("name"),
                connection.getServerTimeZone());
            row.add(columnInfo.getColumnName());
            //data type
            row.add(String.valueOf(columnInfo.getProtonDataType().getSqlType()));
            //type name
    ...
    private ProtonResultBuilder getProtonResultBuilderForGetColumns() {
        ProtonResultBuilder builder = ProtonResultBuilder.builder(24);
        builder.names(
                "TABLE_CAT",
                "TABLE_SCHEM",
                "TABLE_NAME",
    ...
    private ResultSet getEmptyResultSet() {
        return ProtonResultBuilder.builder(1).names("some").types("string").build();
    }
    ...
    public ResultSet getTypeInfo() throws SQLException {
        ProtonResultBuilder builder = ProtonResultBuilder.builder(18);
        builder.names(
                "TYPE_NAME",
                "DATA_TYPE",
                "PRECISION",
    ...
    public int getDatabaseMajorVersion() throws SQLException {
        return ProtonVersion.of(connection.getServerVersion()).getMajorVersion();
    }

    @Override
    public int getDatabaseMinorVersion() throws SQLException {
        return ProtonVersion.of(connection.getServerVersion()).getMinorVersion();
    }
