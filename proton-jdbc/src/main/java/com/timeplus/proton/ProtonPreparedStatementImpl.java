...
import com.timeplus.proton.util.ProtonValueFormatter;

public class ProtonPreparedStatementImpl extends ProtonStatementImpl implements ProtonPreparedStatement {
    private static final Logger log = LoggerFactory.getLogger(ProtonPreparedStatementImpl.class);
    ...
    private final ProtonPreparedStatementParameter[] binds;
    ...
    public ProtonPreparedStatementImpl(CloseableHttpClient client,
        ProtonConnection connection, ProtonProperties properties, String sql,
        TimeZone serverTimeZone, int resultSetType) throws SQLException
    {
        ...
        PreparedStatementParser parser = PreparedStatementParser.parse(sql,
            parsedStmt.getEndPosition(ProtonSqlStatement.KEYWORD_VALUES));
        ...
        this.binds = new ProtonPreparedStatementParameter[numParams];
    ...
    @Override
    public ProtonResponse executeQueryProtonResponse() throws SQLException {
        return executeQueryProtonResponse(buildSql(), null, null);
    }

    @Override
    public ProtonResponse executeQueryProtonResponse(Map<ProtonQueryParam, String> additionalDBParams) throws SQLException {
        return executeQueryProtonResponse(buildSql(), additionalDBParams, null);
    }

    private ProtonSqlStatement buildSql() throws SQLException {
        if (sqlParts.size() == 1) {
            return new ProtonSqlStatement(sqlParts.get(0), parsedStmt.getStatementType());
        }
        ...
        return new ProtonSqlStatement(sb.toString(), parsedStmt.getStatementType());
    }
    ...
    @Override
    public ResultSet executeQuery(Map<ProtonQueryParam, String> additionalDBParams) throws SQLException {
        return executeQuery(additionalDBParams, null);
    }

    @Override
    public ResultSet executeQuery(Map<ProtonQueryParam, String> additionalDBParams, List<ProtonExternalData> externalData) throws SQLException {
    ...
    private void setBind(int parameterIndex, String bind, boolean quote) {
        binds[parameterIndex - 1] = new ProtonPreparedStatementParameter(bind, quote);
    }

    private void setBind(int parameterIndex, ProtonPreparedStatementParameter parameter) {
        binds[parameterIndex -1] = parameter;
    }

    private void setNull(int parameterIndex) {
        setBind(parameterIndex, ProtonPreparedStatementParameter.nullParameter());
    }
    ...
    public void setBoolean(int parameterIndex, boolean x) throws SQLException {
        setBind(parameterIndex, ProtonPreparedStatementParameter.boolParameter(x));
    }

    @Override
    public void setByte(int parameterIndex, byte x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatByte(x), false);
    }

    @Override
    public void setShort(int parameterIndex, short x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatShort(x), false);
    }

    @Override
    public void setInt(int parameterIndex, int x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatInt(x), false);
    }

    @Override
    public void setLong(int parameterIndex, long x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatLong(x), false);
    }

    @Override
    public void setFloat(int parameterIndex, float x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatFloat(x), false);
    }

    @Override
    public void setDouble(int parameterIndex, double x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatDouble(x), false);
    }

    @Override
    public void setBigDecimal(int parameterIndex, BigDecimal x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatBigDecimal(x), false);
    }

    @Override
    public void setString(int parameterIndex, String x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatString(x), x != null);
    }

    @Override
    public void setBytes(int parameterIndex, byte[] x) throws SQLException {
        setBind(parameterIndex, ProtonValueFormatter.formatBytes(x), true);
    }
    ...
    public void setDate(int parameterIndex, Date x) throws SQLException {
        if (x != null) {
            setBind(
                parameterIndex,
                ProtonValueFormatter.formatDate(x, dateTimeZone),
                true);
        } else {
            setNull(parameterIndex);
        }
    ...
    public void setTime(int parameterIndex, Time x) throws SQLException {
        if (x != null) {
            setBind(
                parameterIndex,
                ProtonValueFormatter.formatTime(x, dateTimeTimeZone),
                true);
        } else {
            setNull(parameterIndex);
        }
    ...
    public void setTimestamp(int parameterIndex, Timestamp x) throws SQLException {
        if (x != null) {
            setBind(
                parameterIndex,
                ProtonValueFormatter.formatTimestamp(x, dateTimeTimeZone),
                true);
        } else {
            setNull(parameterIndex);
        }
    ...
    public void setArray(int parameterIndex, Collection collection) throws SQLException {
        setBind(parameterIndex, ProtonArrayUtil.toString(collection, dateTimeZone, dateTimeTimeZone),
            false);
    }

    @Override
    public void setArray(int parameterIndex, Object[] array) throws SQLException {
        setBind(parameterIndex, ProtonArrayUtil.toString(array, dateTimeZone, dateTimeTimeZone), false);
    }

    @Override
    public void setArray(int parameterIndex, Array x) throws SQLException {
        setBind(parameterIndex, ProtonArrayUtil.arrayToString(x.getArray(), dateTimeZone, dateTimeTimeZone),
            false);
    }
    ...
    public void setObject(int parameterIndex, Object x) throws SQLException {
        if (x != null) {
            setBind(
                parameterIndex,
                ProtonPreparedStatementParameter.fromObject(
    ...
    @Override
    public int[] executeBatch(Map<ProtonQueryParam, String> additionalDBParams) throws SQLException {
        int valuePosition = -1;
        ...
        if (type == StatementType.INSERT && parsedStmt.hasValues()) {
            valuePosition = parsedStmt.getStartPosition(ProtonSqlStatement.KEYWORD_VALUES);
        }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        ...
        ResultSet myRs = executeQuery(Collections.singletonMap(
            ProtonQueryParam.MAX_RESULT_ROWS, "0"));
    ...
    public void setDate(int parameterIndex, Date x, Calendar cal) throws SQLException {
        if (x != null && cal != null && cal.getTimeZone() != null) {
            setBind(
                parameterIndex,
                ProtonValueFormatter.formatDate(x, cal.getTimeZone()),
                true);
        } else {
    ...
    public void setTime(int parameterIndex, Time x, Calendar cal) throws SQLException {
        if (x != null && cal != null && cal.getTimeZone() != null) {
            setBind(
                parameterIndex,
                ProtonValueFormatter.formatTime(x, cal.getTimeZone()),
                true);
        } else {
    ...
    public void setTimestamp(int parameterIndex, Timestamp x, Calendar cal) throws SQLException {
        if (x != null && cal != null && cal.getTimeZone() != null) {
            setBind(
                parameterIndex,
                ProtonValueFormatter.formatTimestamp(x, cal.getTimeZone()),
                true);
        } else {
