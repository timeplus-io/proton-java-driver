 ...
 */
public final class ProtonColumnInfo {
    ...
    private ProtonDataType protonDataType;
    private final String originalTypeName;
    private final String columnName;
    private boolean nullable;
    private boolean lowCardinality;
    private int arrayLevel;
    private ProtonDataType arrayBaseType;
    private TimeZone timeZone;
    private int precision;
    private int scale;
    private ProtonColumnInfo keyInfo;
    private ProtonColumnInfo valueInfo;
    private String functionName;

    @Deprecated
    public static ProtonColumnInfo parse(String typeInfo, String columnName) {
     ...
     * @return parsed type
     */
    public static ProtonColumnInfo parse(String typeInfo, String columnName, TimeZone serverTimeZone) {
        ProtonColumnInfo column = new ProtonColumnInfo(typeInfo, columnName);
        int currIdx = 0;
        while (typeInfo.startsWith(KEYWORD_ARRAY, currIdx)) {
            column.arrayLevel++;
            column.protonDataType = ProtonDataType.Array;
        ...
        case AggregateFunction :
            ...
            column.arrayBaseType = ProtonDataType.Unknown;
            if (argsAf.length == 2) {
                column.arrayBaseType = ProtonDataType.fromTypeString(argsAf[1]);
            }
            break;
        case DateTime :
        ...
        case Map:
            ...
            if (argsMap.length == 2) {
                column.keyInfo = ProtonColumnInfo.parse(argsMap[0], columnName + "Key", serverTimeZone);
                column.valueInfo = ProtonColumnInfo.parse(argsMap[1], columnName + "Value", serverTimeZone);
            }
            break;
        default:
            break;
    ...
    private ProtonColumnInfo(String originalTypeName, String columnName) {
        this.originalTypeName = originalTypeName;
        this.columnName = columnName;
    }

    public ProtonDataType getProtonDataType() {
        return protonDataType;
    }
    ...
    public ProtonDataType getArrayBaseType() {
        return arrayBaseType;
    }

    public ProtonDataType getEffectiveProtonDataType() {
        return arrayLevel > 0 ? arrayBaseType : protonDataType;
    }
    ...
    public ProtonColumnInfo getKeyInfo() {
        return this.keyInfo;
    }

    public ProtonColumnInfo getValueInfo() {
