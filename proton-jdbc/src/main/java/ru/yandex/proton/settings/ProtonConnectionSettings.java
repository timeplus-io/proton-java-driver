...
public enum ProtonConnectionSettings implements DriverPropertyCreator {
    ...
    * */
    DATA_TRANSFER_TIMEOUT( "dataTransferTimeout", 10000, "Timeout for data transfer. "
            + " socketTimeout + dataTransferTimeout is sent to Proton as max_execution_time. "
            + " Proton rejects request execution if its time exceeds max_execution_time"),
    ...
    ProtonConnectionSettings(String key, Object defaultValue, String description) {
        this.key = key;
