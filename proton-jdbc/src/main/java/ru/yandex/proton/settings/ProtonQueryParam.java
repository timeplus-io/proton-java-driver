package ru.yandex.proton.settings;
...
public enum ProtonQueryParam implements DriverPropertyCreator {
    ...
    SEND_PROGRESS_IN_HTTP_HEADERS("send_progress_in_http_headers", null, Boolean.class, "Allow to populate summary in ProtonStatement with read/written rows/bytes"),
    ...
    ENABLE_OPTIMIZE_PREDICATE_EXPRESSION("enable_optimize_predicate_expression", null, Boolean.class, "See Proton server description for this parameter. Default value is null so that server setting is taken."),
    ...
    <T> ProtonQueryParam(String key, T defaultValue, Class<T> clazz, String description) {
        this.key = key;
