...
/**
 * Very simple version number parser. It is only needed for Proton driver
 * and database version numbers
 * 
 * @deprecated As of release 0.3.2, replaced by
 *             {@link com.proton.client.ProtonVersion} and it will be
 *             removed in 0.4.0
 */
@Deprecated
public final class ProtonVersionNumberUtil {
    ...
    private ProtonVersionNumberUtil() {
