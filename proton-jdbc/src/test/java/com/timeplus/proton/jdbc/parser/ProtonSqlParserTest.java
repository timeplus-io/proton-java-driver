...
public class ProtonSqlParserTest {
    ...
    public void testInsertStatement() throws ParseException {
        ...
        assertEquals(s.getContentBetweenKeywords(ProtonSqlStatement.KEYWORD_VALUES_START,
        ...
        assertEquals(s.getContentBetweenKeywords(ProtonSqlStatement.KEYWORD_STREAM_COLUMNS_START,
    ...
    public void testSelectStatement() {
        ...
        Assert.assertEquals(parse(sql = "select 314 limit 5\nFORMAT JSONCompact;"),
                new ProtonSqlStatement[] {
        ...
        Assert.assertEquals(parse(sql = loadSql("issue-441_with-totals.sql")),
        ...
        Assert.assertEquals(parse(sql = loadSql("issue-555_custom-format.sql")),
                new ProtonSqlStatement[] {
                        new ProtonSqlStatement(sql, StatementType.SELECT, null, null, "wrd",
                                null, "CSVWithNames", null, null, null, null, null) });
        Assert.assertEquals(parse(sql = loadSql("with-clause.sql")),
                new ProtonSqlStatement[] {
