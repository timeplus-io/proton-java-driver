...
public class FakeTransactionTest {
    ...
    public void testSavepoint() throws SQLException {
        ...
        FakeTransaction.FakeSavepoint unnamedSavepoint = tx.newSavepoint(null);
        FakeTransaction.FakeSavepoint s1 = unnamedSavepoint;
        ...
        FakeTransaction.FakeSavepoint namedSavepoint = tx.newSavepoint("tmp");
        FakeTransaction.FakeSavepoint s2 = namedSavepoint;
        ...
        String queryId = tx.newQuery(null);
        FakeTransaction.FakeSavepoint s3 = unnamedSavepoint = tx.newSavepoint(null);
        ...
        tx.newQuery(null);
        FakeTransaction.FakeSavepoint s4 = namedSavepoint = tx.newSavepoint("tmp");
