...
To succesfully built the jar and pass the tests, you need to start Timeplus Proton server with 3218 port open. You can use [this docker compose file](https://github.com/timeplus-io/proton/tree/develop/examples/jdbc).
